...
const NavBar = () => {
  return (
    <Popover className=" container mx-auto flex justify-between items-center lg:gap-20 px-6 py-2 h-24 ">
      <div className="text-2xl font-bold cursor-pointer">Lukman</div>
      ...
      <Popover.Overlay className="lg:hidden fixed inset-0 bg-black opacity-30" />
      <Transition
        o6={Fragment}
      ...
      >
        <Popover.Panel className="absolute inset-x-0 top-0 origin-top-right transform p-2 transition lg:hidden">
